        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed bottom-4 md:bottom-10 lg:bottom-12 right-4 z-50 w-[90vw] md:w-[400px] h-[600px] max-h-[80vh] flex flex-col panel-glass rounded-2xl overflow-hidden"
                >
                    {/* Header */}
