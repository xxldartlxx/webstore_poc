        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed bottom-4 right-4 z-50 w-[90vw] md:w-[400px] h-[600px] max-h-[80vh] flex flex-col glass-card shiny-border glow-medium rounded-2xl overflow-hidden"
                >
                    {/* Header */}
