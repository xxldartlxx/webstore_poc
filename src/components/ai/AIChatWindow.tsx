        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed bottom-4 right-4 z-50 w-[90vw] md:w-[400px] h-[600px] max-h-[80vh] flex flex-col bg-card/95 backdrop-blur-xl border border-border shadow-2xl rounded-2xl overflow-hidden"
                >
                    {/* Header */}
